...
@Component({
  selector: 'app-costs-results-page',
  templateUrl: './costs-results-page.component.html',
  styleUrls: ['./costs-results-page.component.scss']
})
export class CostsResultsPageComponent implements OnInit, OnDestroy {
    ...
    public numberFormat = '.0f';
    public valueColors = ['#e74c3c', '#f7c1bb', '#fbedb7', '#c1f1d5', '#2ecc71'].reverse();
